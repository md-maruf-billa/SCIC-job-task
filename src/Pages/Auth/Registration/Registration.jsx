            ...
            <div className="w-full max-w-md bg-white shadow-lg p-8 space-y-3 rounded-xl ">
                ...
                <form noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="username" id="username" placeholder="Jhon" className="w-full px-4 py-3 rounded-md border " />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="username" className="block ">E-mail</label>
                        <input type="text" name="username" id="username" placeholder="demo@gmail.com" className="w-full px-4 py-3 rounded-md border " />
                    </div>
                    <div className="space-y-1 text-sm">
